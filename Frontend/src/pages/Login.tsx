...
export default function Login() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-emerald-600 via-emerald-700 to-slate-900 flex items-center justify-center p-6">
            {/* Background Pattern */}
            ...
            <div className="relative w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    <div className="inline-flex items-center justify-center w-24 h-24 bg-white/90 backdrop-blur-sm rounded-full mb-4 border-4 border-white/20 shadow-xl overflow-hidden p-2">
                        <img src="/logo.png" alt="Logo SMA Plus Cendikia Cikeas" className="w-full h-full object-contain" />
                    </div>
                    <h1 className="text-4xl font-bold text-white mb-2">SchoolGuard</h1>
                    <p className="text-emerald-100">Sistem Keamanan Sekolah</p>
                </div>
                ...
                <div className="bg-white rounded-2xl shadow-2xl p-8">
                    ...
                    {debugInfo && (
                        <div className="mb-6 bg-emerald-50 border border-emerald-200 rounded-lg p-4">
                            <p className="text-emerald-800 text-xs font-mono">{debugInfo}</p>
                        </div>
                    )}
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full py-4 bg-gradient-to-r from-emerald-600 to-green-600 hover:from-emerald-700 hover:to-green-700 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed mt-6 active:scale-95"
                        >
                            {loading ? (
                                <>
